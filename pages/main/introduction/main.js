...
export default function introduction(){
    ...
    window.addEventListener(
        ...
        async function a(){
            ...
            if(scrolled < viewport*3 && background.src != "http://127.0.0.1:5500/assets/zootopia.jpg"){
            ...
            else if(scrolled >= viewport*3 && background.src != "http://127.0.0.1:5500/assets/dengo.png"){
                background.style.opacity = 0
                await new Promise(resolve => setTimeout(resolve, 501))
